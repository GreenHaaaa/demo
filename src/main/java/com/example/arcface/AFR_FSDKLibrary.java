...
public interface AFR_FSDKLibrary extends Library {
    AFR_FSDKLibrary INSTANCE = (AFR_FSDKLibrary)LoadUtils.loadLibrary(Platform.isWindows()?"libarcsoft_fsdk_face_recognition.dll":"/usr/local/arcface/libarcsoft_fsdk_face_recognition.so",AFR_FSDKLibrary.class);
